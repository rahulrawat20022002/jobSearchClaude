...
## Profile
Data Science and Analytics Master student at SRH Heidelberg based in Mannheim, focused on generative AI systems and cloud native data platforms. I have shipped a hybrid retrieval augmented generation system on Llama 3.1 with a routing agent, ChromaDB, and stateful memory, a cloud native BigQuery medallion pipeline with a BigQuery ML classifier, and CreditIQ, a fairness by design credit scoring system that clears the EU AI Act 80 percent threshold. I am well suited to strengthen the Generative AI on Google Cloud practice at REPLY in Berlin.
