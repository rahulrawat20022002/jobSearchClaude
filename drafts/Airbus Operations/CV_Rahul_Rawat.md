...
Data Science and Analytics Master student at SRH Heidelberg based in Mannheim, with direct hands on experience turning aircraft position data into insight. My Real Time Flight Tracking Data Pipeline polls live positions from the OpenSky Network every 30 seconds, enriches each observation against airport, aircraft, and weather data on Google Cloud, and lands more than 128 thousand joined records through PySpark and dbt on Airflow. I combine that with a full Bronze to Gold BigQuery ML pipeline on the Movie Analytics project and a Hybrid RAG Orchestrator on Llama 3.1, which covers the Big Data plus generative AI foundation this Configuration Management working student role calls for.
