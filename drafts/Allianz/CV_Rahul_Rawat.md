...
Data Science and Analytics Master student at SRH Heidelberg based in Mannheim, with hands on experience turning raw operational data into business relevant analytics. I have shipped an interactive Tableau dashboard with dynamic parameters, a five page Looker Studio dashboard on top of a BigQuery medallion warehouse, and a Random Forest study translating raw event data into stakeholder ready insight. Comfortable with SQL, dashboarding tools, and clean data storytelling, I am well suited to strengthen the Data Analyst function at Allianz.
