...
## Werkstudent Business Intelligence und Analytics

Masterstudent der Data Science and Analytics an der SRH Heidelberg mit Sitz in Mannheim und praktischer Erfahrung im Bau interaktiver Dashboards und in der Uebersetzung komplexer Analysen in verstaendliche Insights fuer nicht technische Stakeholder. Ich habe ein Tableau Dashboard mit dynamischem Set Actions Warenkorb und ein 5 seitiges Looker Studio Dashboard fuer Geschaeftsfragen zu ROI und Timing gebaut sowie eine Random Forest Analyse globaler Klimaereignisse bis zum management fertigen Report gefuehrt. Sicher in SQL, Python, Power BI, Tableau und in der strukturierten Aufbereitung von Daten fuer Marketing, Sales und Automatisierung.
