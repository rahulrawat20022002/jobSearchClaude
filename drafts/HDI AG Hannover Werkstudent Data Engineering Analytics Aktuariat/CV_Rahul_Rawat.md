...
## Werkstudent Data Engineering und Analytics im Aktuariat

Masterstudent der Data Science and Analytics an der SRH Heidelberg mit Sitz in Mannheim und praktischer Erfahrung im Aufbau von Datenpipelines, Analytik und BI Reporting. Ich habe eine end to end Cloud Batch Pipeline auf GCP mit BigQuery Medallion Architektur und Looker Studio gebaut sowie eine Echtzeit Flugverfolgungs Pipeline mit PySpark, dbt und Apache Airflow ueber 128 tausend Datensaetze orchestriert. Sicher in Python, SQL, PySpark und im Aufbau reproduzierbarer Datenpipelines.
