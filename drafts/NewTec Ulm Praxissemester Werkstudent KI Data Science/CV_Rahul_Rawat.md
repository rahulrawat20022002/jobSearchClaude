...
## Praxissemester Werkstudent KI und Data Science

Masterstudent der Data Science and Analytics an der SRH Heidelberg mit Sitz in Mannheim und praktischer Erfahrung im Aufbau von Datenbankabfragen, Machine Learning Pipelines und KI Anwendungsfaellen fuer den Unternehmensalltag. Ich habe eine Real Time Flight Tracking Pipeline mit SQL nahen dbt Modellen auf Google Cloud gebaut und in einem Multi Agent RAG System KI Anwendungsfaelle end to end von der Idee bis zur Auswertung umgesetzt. Sicher in Python, SQL, dbt, BigQuery sowie in der abteilungsuebergreifenden Zusammenarbeit mit Fachexpertinnen und Fachexperten.
