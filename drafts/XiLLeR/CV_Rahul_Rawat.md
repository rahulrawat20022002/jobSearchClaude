...
Data Science and Analytics Master student at SRH Heidelberg based in Mannheim, actively seeking a mandatory Praxissemester in Data Science and AI. I have shipped a modular Retrieval Augmented Generation system on Llama 3.1, a fairness aware credit scoring system with a full EU AI Act write up, and a Bachelor Thesis on machine learning for clinical prediction with honest limitation reporting. Comfortable working remotely, I am well positioned to contribute meaningfully to XiLLeR's Data Science and KI work from day one.
