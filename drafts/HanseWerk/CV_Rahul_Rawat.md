...
Data Science and Analytics Master student at SRH Heidelberg based in Mannheim, with hands on experience building interactive dashboards and BI stories from raw operational data. I have shipped a two tier Tableau dashboard with dynamic parameters and Set Actions, a five page Looker Studio dashboard on top of a BigQuery medallion warehouse, and a Random Forest study translating raw event data into stakeholder ready insight. Comfortable with Power BI style tools, SQL, and clean data storytelling, I am well suited to strengthen HSEQ reporting at HanseWerk.
