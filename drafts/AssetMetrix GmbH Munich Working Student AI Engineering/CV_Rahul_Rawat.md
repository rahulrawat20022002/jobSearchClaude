...
Master's student in Data Science and Analytics at SRH University of Applied Sciences Heidelberg with hands on experience in Python AI system design, cloud data pipelines, and production data science. Built a multi agent RAG system with LangGraph and Ollama with automated evaluation across five retrieval and four generation metrics, and a real time flight tracking data engineering pipeline on GCP with dbt and Airflow refreshing more than 128 thousand records every 15 minutes. Comfortable in Python, LangGraph, Ollama, PySpark, dbt, Airflow, BigQuery, GCP and AWS.
