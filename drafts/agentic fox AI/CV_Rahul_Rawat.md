...
Data Science and Analytics Master student at SRH Heidelberg based in Mannheim, with hands on experience building agentic language model systems end to end. I have shipped a modular Retrieval Augmented Generation system on Llama 3.1 with a decision making router and a stateful memory agent, a fairness aware credit scoring system with a full EU AI Act write up, and a Bachelor Thesis with rigorous model evaluation. Fluent in Python and modern LLM tooling, I am well suited to help agentic fox AI ship AI automation and agent engineering work.
