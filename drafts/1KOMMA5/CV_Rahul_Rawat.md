...
Data Science and Analytics Master student at SRH Heidelberg with hands on experience shipping time series forecasting pipelines that run against real sensor data. My six month collaboration with eRay GmbH built recursive forecasts for four water quality signals using CatBoost multi quantile regression, strict anti leakage rules, and MICE imputation, exactly the mix of ML engineering and honest evaluation that a live production energy forecasting stack needs. I am fluent in Python, comfortable with SQL and BigQuery from my cloud pipeline projects, and keen to contribute to 1KOMMA5's Heartbeat AI and agentic workflow ambitions.
