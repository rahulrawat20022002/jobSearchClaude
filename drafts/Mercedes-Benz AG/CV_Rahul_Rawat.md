...
## Profile
Data Science and Analytics Master student at SRH Heidelberg based in Mannheim, with hands on experience turning raw operational and telemetry data into analytics ready tables and dashboards. I have shipped a cloud native BigQuery medallion pipeline with a five page Looker Studio dashboard, a Tableau meal simulator with dynamic parameters, and a Random Forest study on the economic impact of global events. I am well suited to strengthen data analytics and project control across the MB.OS end to end journey at Mercedes Benz AG in Böblingen.
