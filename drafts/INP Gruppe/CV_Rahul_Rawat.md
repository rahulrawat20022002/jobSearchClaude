...
Data Science and Analytics Master student at SRH Heidelberg based in Mannheim, with hands on experience shipping neural network and machine learning projects on real world data. I have built a fairness aware credit scoring system with a full EU regulatory write up, a recursive time series forecasting pipeline for a German lake, and a modular Retrieval Augmented Generation system on Llama 3.1. Comfortable in Python, PyTorch friendly workflows, and cloud data pipelines, I am well positioned to apply machine learning and neural networks to automation problems at INP Gruppe.
