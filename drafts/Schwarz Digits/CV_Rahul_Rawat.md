...
## Profile
Data Science and Analytics Master student at SRH Heidelberg based in Mannheim, focused on deep learning, retrieval augmented generation, and cloud native data platforms. I have shipped a hybrid RAG system on Llama 3.1 with routing and stateful memory, a fairness by design credit scoring system that clears the EU AI Act 80 percent threshold, and a BigQuery medallion pipeline with a hit or miss BigQuery ML classifier. I am well suited to strengthen the Computer Vision and Deep Learning group at Schwarz Digits in Bad Friedrichshall, close to my base in Mannheim.
