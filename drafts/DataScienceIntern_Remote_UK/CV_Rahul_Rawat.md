...
Data Science and Analytics Master student at SRH Heidelberg with hands on experience turning raw data into shipped machine learning solutions, not just analysis. My six month collaboration with eRay GmbH delivered a recursive time series forecasting pipeline on real sensor data, and my personal work spans classification with SHAP explainability, cloud data pipelines on GCP, and a Retrieval Augmented Generation system with a custom intent router. I combine strong Python and SQL fundamentals with clear storytelling for non technical stakeholders, and I am comfortable working remotely on UK time zones.
