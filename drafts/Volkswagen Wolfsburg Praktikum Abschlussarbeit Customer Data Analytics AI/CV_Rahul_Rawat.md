...
## Praktikum oder Abschlussarbeit Customer Data Analytics und AI

Masterstudent der Data Science and Analytics an der SRH Heidelberg mit Sitz in Mannheim und praktischer Erfahrung in Predictive Analytics, statistischer Modellierung und dem Uebersetzen von Kundendaten in belastbare Entscheidungsgrundlagen. Ich habe Random Forest Modelle zur Analyse wirtschaftlicher Zusammenhaenge entwickelt und in einem Cloud Data Projekt einen BigQuery ML Klassifikator mit sauber getrennten Pre Release Signalen trainiert. Sicher in Python, SQL, scikit-learn, statistischer Modellierung und in der Kommunikation technischer Ergebnisse an nicht technische Stakeholder.
