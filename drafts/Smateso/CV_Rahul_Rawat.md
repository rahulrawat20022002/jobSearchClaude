...
Data Science and Analytics Master student at SRH Heidelberg based in Mannheim, with hands on experience shipping data science and AI systems on real data. I have built a modular Retrieval Augmented Generation system on Llama 3.1, a fairness aware credit scoring system with a full EU AI Act write up, and a Bachelor Thesis comparing six classifiers with 10 fold cross validation. Comfortable working fully remote, I am well positioned to contribute to Smateso's Data Scientist and AI Engineer work from day one.
