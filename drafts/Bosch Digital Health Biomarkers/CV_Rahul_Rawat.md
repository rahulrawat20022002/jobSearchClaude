...
## Profile
Data Science and Analytics Master student at SRH Heidelberg based in Mannheim, looking for a Master Thesis at the intersection of applied machine learning and health signals. My published grade Bachelor Thesis on diabetes prediction, my industry lake water forecasting collaboration with eRay GmbH, and my fairness aware CreditIQ project together show that I can run a full leakage aware model comparison, an honest evaluation, and a regulator defensible write up. I am well suited to a Master Thesis on ambient sensing for digital health biomarkers at Bosch in Renningen.
