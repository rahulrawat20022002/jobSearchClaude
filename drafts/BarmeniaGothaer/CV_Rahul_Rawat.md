...
## Profile
Data Science and Analytics Master student at SRH Heidelberg based in Mannheim, focused on business intelligence, data warehousing, and clean data storytelling. I have shipped a cloud native BigQuery medallion warehouse with a five page Looker Studio dashboard, an interactive Tableau meal simulator with dynamic parameters and Set Actions, and a Random Forest study on the economic impact of global events. Comfortable with SQL, dimensional modelling patterns, and BI reporting, I am well suited to strengthen the Business Intelligence and SAP Data Warehouse function at BarmeniaGothaer in Köln.
