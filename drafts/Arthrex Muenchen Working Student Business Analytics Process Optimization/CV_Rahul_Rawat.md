...
Master's student in Data Science and Analytics at SRH Heidelberg, based in Mannheim, with hands on experience turning raw operational data into dashboards and decision support for non technical stakeholders. I built a Tableau based Fast Food Nutritional Analyzer with Set Actions and parameter driven analytics, and delivered an end to end climate economics analytics pipeline from raw CSV to a management ready report using Random Forest models and calibrated confidence statements. Comfortable across Python, SQL, Tableau and Excel for business facing reporting.
