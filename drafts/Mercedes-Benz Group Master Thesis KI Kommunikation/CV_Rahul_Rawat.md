...
## Profile
Data Science and Analytics Master student at SRH Heidelberg based in Mannheim, looking for a Master Thesis at the intersection of applied language models and industrial diagnostics. My hybrid RAG orchestrator on Llama 3.1, my fairness by design CreditIQ system, and my Hadoop based distributed crawling and processing platform together show that I can design modular language and retrieval systems, evaluate them honestly, and run a full ingest and processing pipeline over unstructured text. I am well suited to a Master Thesis on KI based analysis of communication data in diagnostic processes at Mercedes Benz Group in Sindelfingen.
...
**Hadoop Based Data Crawling and Processing Platform**: Python with Selenium and BeautifulSoup, Pandas, Docker Swarm, Hadoop HDFS, SQL Server
...
- Built a decoupled web scraping pipeline in Python and Selenium to navigate dynamic and paginated e commerce results, saving raw HTML locally for data safety.
